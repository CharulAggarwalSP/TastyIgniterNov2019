...
<?= get_style_tags(); ?>
<?= '<link rel="stylesheet" type="text/css" href="'.theme_url().'/dosa-restaurant-theme/assets/css/app.css"'.'>'; ?>
...
<?= '<link rel="stylesheet" type="text/css" href="'.assets_url().'/vd-theme/css/default-theme-style.css"'.'>'; ?>
