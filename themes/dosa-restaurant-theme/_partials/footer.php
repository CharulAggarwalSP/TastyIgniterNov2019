...
">Overtoom 146<br>1054 HS<br>Amsterdam<br>Netherlands</li>
						...
						<li><i class="fa fa-fax" aria-hidden="true" style="color:rgba(255, 255, 255, 0.75)"></i> <?= $this->controller->locationData()->location_fax ?> </li>
					</ul>
				</div> 
			</div>
            <div class="col-sm-4">
    ...
    <div class="container">
        <div class="row">
            <div class="col p-2">                 
                ...
                <a href="<?=assets_url('media/policy/privacy.pdf')?>" target="_blank">Privacy Policy</a>&nbsp;&nbsp;&nbsp;
                <a href="<?=assets_url('media/policy/cookie.pdf')?>" target="_blank">Cookies Policy</a>
            </div>
        </div>
    </div>
</div>
