...
class Reservation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            ['first_name', 'admin::lang.reservations.label_first_name', 'required|between:2,32|regex:/^(?!\s*$)[A-Z-a-z]+$/i'],
            ['last_name', 'admin::lang.reservations.label_last_name', 'required|between:2,32|regex:/^(?!\s*$)[A-Z-a-z]+$/i'],
