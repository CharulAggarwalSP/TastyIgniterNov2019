...
class Location extends FormRequest
{
    public function rules()
    {
        return [
            ...
            ['offer_delivery', 'admin::lang.locations.label_offer_delivery', 'boolean'],
            ['offer_collection', 'admin::lang.locations.label_offer_collection', 'boolean'],
            ['options.offer_reservation', 'admin::lang.locations.label_offer_collection', 'boolean'],
            ['delivery_time', 'admin::lang.locations.label_delivery_time', 'integer'],
            ['collection_time', 'admin::lang.locations.label_collection_time', 'integer'],
            ['last_order_time', 'admin::lang.locations.label_last_order_time', 'integer'],
            ['options.future_orders', 'admin::lang.locations.label_future_order', 'boolean'],
            ['options.future_order_days.*', 'admin::lang.locations.label_future_order_days', 'integer'],
            ['options.payments.*', 'admin::lang.locations.label_payments'],
            ['reservation_time_interval', 'admin::lang.locations.label_reservation_time_interval', 'integer'],
            ['reservation_stay_time', 'admin::lang.locations.label_reservation_stay_time', 'integer'],
